...
// on rend la progressbar visible pour le chargement des infos BDD
        progressbar.visibility = View.VISIBLE



        // on lit les infos dans la bdd pour le:
        // proc
    ...
    private fun read(child:String, id: TextView){
        database.getReference("Config 2000").child(child)
    ...
    private fun readLienProc(){
        database.getReference("Config 2000").child("lien_processeur")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienRam(){
        database.getReference("Config 2000").child("lien_ram")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienCg(){
        database.getReference("Config 2000").child("lien_cg")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienCm(){
        database.getReference("Config 2000").child("lien_cm")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienBoitier(){
        database.getReference("Config 2000").child("lien_boitier")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienAlim(){
        database.getReference("Config 2000").child("lien_alim")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienWatercooling(){
        database.getReference("Config 2000").child("lien_watercooling")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienSsd(){
        database.getReference("Config 2000").child("lien_ssd")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
