...
import kotlinx.android.synthetic.main.activity_souris_filaires.*
import org.w3c.dom.Text

class SourisFilairesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_souris_filaires)
    ...
    private fun read(child:String, id:TextView){
        database.getReference("sourisFilaires").child(child)
    ...
    private fun readLienSouris1(){
        database.getReference("sourisFilaires").child("lien_souris1")
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienSouris2(){
        database.getReference("sourisFilaires").child("lien_souris2")
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
