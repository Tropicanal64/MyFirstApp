...
class MecaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_meca)
...
// on lit les infos des produit dans la BDD
    private fun read(child:String, id: TextView){
        database.getReference("claviers").child(child)
    ...
    private fun readLienClavier1(){
        database.getReference("claviers").child("lien_clavier1")
            .addListenerForSingleValueEvent(object: ValueEventListener{
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
    ...
    private fun readLienClavier2(){
        database.getReference("claviers").child("lien_clavier2")
            .addListenerForSingleValueEvent(object: ValueEventListener{
                override fun onCancelled(p0: DatabaseError) {
                    TODO("Not yet implemented")
                }
